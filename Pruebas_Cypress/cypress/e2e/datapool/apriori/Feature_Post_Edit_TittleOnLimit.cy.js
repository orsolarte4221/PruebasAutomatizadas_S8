describe('Gestión Post', () => {
  ...
  it('Hacer Login, Crear Post, Editar un post, Publicar Post y Validar publicación', () => {
      ...
      cy.wait(3000);
      cy.get(properties.elements["post-title-input"]).clear().type(postData.postlimit.titlelimit);
      ...
      cy.wait(3000);
      cy.get(properties.elements["post-title"]).contains(postData.postlimit.titlelimit).should('exist');
