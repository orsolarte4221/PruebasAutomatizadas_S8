...
metadata_title = metadata_title.slice(0,60)




describe('Añade un titulo a los metadatos con el limite de caracteres', () => {
  it('Añade un titulo a los metadatos con el limite de caracteres', () => {
