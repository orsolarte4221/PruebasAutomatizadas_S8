...
describe('Añade un titulo a los metadatos de FB arriba del limite de caracteres', () => {
  it('Añade un titulo a los metadatos de FB arriba del limite de caracteres', () => {
      ...
      cy.get('textarea[name="post-setting-og-description"]').click()
      
      
      
      cy.get('.response').should('contain', 'Facebook Title cannot be longer than 300 characters.')
